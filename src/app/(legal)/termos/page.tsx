import { SITE_NAME, SITE_INFO, LEGAL } from '@/lib/constants';
    ...
    <div>
      <div className="mb-8 text-center">
        ...
        <p className="mt-4 text-lg text-secondary-600 dark:text-secondary-400">
          Leia atentamente os termos e condições de uso do {SITE_NAME}
        </p>
      </div>
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert">
        ...
        <p>
          Ao acessar e usar o {SITE_NAME}, você concorda em cumprir estes Termos
          de Uso e todas as leis e regulamentos aplicáveis. Se você não
        ...
        <p>
          O {SITE_NAME} fornece um serviço de notícias online. Você concorda em
          usar este serviço apenas para propósitos legais e de uma maneira que
        ...
        <p>
          Ao postar comentários ou outro conteúdo no {SITE_NAME}, você concede
          ao
          {SITE_NAME} uma licença não exclusiva para usar, reproduzir, adaptar e
          publicar o conteúdo.
        </p>

        <h2>5. Propriedade Intelectual</h2>
        <p>
          Todo o conteúdo publicado no {SITE_NAME}, incluindo textos, gráficos,
        ...
        <p>
          O {SITE_NAME} não será responsável por quaisquer danos diretos,
          indiretos, incidentais, consequenciais ou punitivos resultantes do seu
          uso do site.
        </p>
        ...
        <p>
          O {SITE_NAME} reserva-se o direito de modificar estes termos a
          qualquer momento. Continuando a usar o site após as alterações, você
          aceita os termos modificados.
        </p>
        ...
        <p>
          ...
          contato conosco através do email {SITE_INFO.email} ou da nossa{' '}
